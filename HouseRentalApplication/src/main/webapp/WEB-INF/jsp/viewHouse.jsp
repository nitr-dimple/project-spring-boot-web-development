                    ...
                    <c:forEach var="housePhoto" items="${requestScope['housePhotos']}">
                        <c:if test="${housePhoto.getHouseId() eq house.getId()}">
                            <div class="card col-xs-3" style="width: 20rem; height: 20rem; border: 1px solid black; margin-left: 20px; margin-top: 10px;">
                                <img src="<%=request.getContextPath()%>/images/${housePhoto.getImagename()}" alt="Avatar" style="width:100%; height:70%">
                                <div class="container">
                                    <br>
                                    <form method="POST" class="" action="${pageContext.request.contextPath}/user/deleteHousePhoto.htm">
                                        <input type="hidden" name="housePhotoDeleteId" value="${housePhoto.getId()}">
                                        <input type="submit" value="Delete" class="btn btn-primary" name="deleteHousePhoto">
                                    </form>
                                </div>
                            </div>
                        </c:if>
