...
public class UserValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ValidationUtils.rejectIfEmpty(errors, "fullname", "empty-fullname", "fullname can not be empty");
        ...
        ValidationUtils.rejectIfEmpty(errors, "gender", "empty-gender", "Gender can not be empty");
